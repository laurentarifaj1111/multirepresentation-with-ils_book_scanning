...
class MultiRepresentationSolution:
    def hill_climbing(self, current_solution: SolutionRepresentation, instance_value: Instance, iterations: int) -> SolutionRepresentation:
